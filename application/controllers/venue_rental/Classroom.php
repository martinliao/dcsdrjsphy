...
class Classroom extends MY_Controller
{
    ...
    public function index()
    {
        ...
        if ($this->data['filter']['room_type'] != '') {
            ...
            if(isset($this->data['filter']['sort']) && $this->data['filter']['room_type']==''){
                ...
                redirect(base_url("venue_rental/classroom"));
            }
        }
        ...
        $this->data['link_add'] = base_url("venue_rental/classroom/add/?{$_SERVER['QUERY_STRING']}");
		$this->data['link_refresh'] = base_url("venue_rental/classroom/");


        $this->layout->view('venue_rental/classroom/list', $this->data);
    }
    ...
    public function add($id=NULL)
	{
		...
		if ($post = $this->input->post()) {
			if ($this->_isVerify('add') == TRUE) {
                ...
                if($used_room){
                    ...
                    redirect(base_url("venue_rental/classroom/add/{$post['seq_no']}?".$_SERVER['QUERY_STRING']));
                }
		...
		$this->data['link_save'] = base_url("venue_rental/classroom/add/?{$_SERVER['QUERY_STRING']}");
		$this->data['link_cancel'] = base_url("venue_rental/classroom/?{$_SERVER['QUERY_STRING']}");
		$this->layout->view('venue_rental/classroom/add', $this->data);
	}
