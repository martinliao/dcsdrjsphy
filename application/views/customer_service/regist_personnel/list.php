                ...
                <div class="row">
                    <form id="filter-form" role="form" class="form-inline">
                        ...
                        <div class="col-xs-12">
                            ...
                            <div>
                                <font color="red">1、承辦人事人員資料異動時，請至28A修正基本資料，以免漏失調訓通知。<br/>2、夜間／假日語言班－須由學員自行至臺北e大語言自費進修班期專區上網報名，經審核及繳費後，始完成報名程序。</font>
                            </div>
                        </div>
                    </form>
                </div>
                    ...
                    <table class="table table-bordered table-condensed table-hover">
                        ...
                        <?php foreach ($list as $row) { ?>
                            <tr>
                                ...
                                <td><a href="#" onclick="window.open('<?=$row['link_class']?>','_blank','toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=yes,resizable=no,height=500,width=650')" style="color:black" ><?=$row['class_name'];?></a></td>  <!-- 20210713修正連結至課表 -->
