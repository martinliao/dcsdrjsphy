...
function popupOK(x){
  window.opener.document.getElementById("tmp_bid").value = x.value;
  window.opener.selbeaurauOK();
  window.close();
}
</script>
...
&nbsp;包含裁撤機關<input type="checkbox" name="key1" id="key1" value="Y" <?=($filter['key1']=='Y')?'checked':'';?> >
            ...
            ?>
				...
				<tr>
				  <td width="50" align="center" bgcolor="#E9EEF4">選取</td>
					<td width="130" align="center" bgcolor="#E9EEF4">局處代碼</td>
					<td align="center" bgcolor="#E9EEF4">局處名稱</td>
					<td align="center" bgcolor="#E9EEF4">裁撤註記</td>
        </tr>
        <?php
        foreach($bureau_list as $fields){
          echo "<tr>";
          echo '<td align="center" bgcolor="#ffffff">';
          $value = $fields['bureau_id'] . "::" . $fields['name'];
          echo '<input id="Arrsel" name="Arrsel" type="radio" value="' . $value . '" onclick="popupOK(this)">';
          echo '</td>';
          echo '<td align="center" bgcolor="#ffffff">' . $fields['bureau_id'] . '</td>';
          echo '<td align="left" bgcolor="#ffffff">' . $fields['name'] . '</td>';
          echo '<td align="left" bgcolor="#ffffff">' . $fields['del_flag'] . '</td>';
          echo "</tr>";
        }
        ?>
        <tr>
