                ...
                <table  border="1" id="printTable" class="table table-bordered table-condensed table-hover">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center" rowspan="2">開放性<br>意見表<br>下載(22G)</th>
                            <th class="text-center" rowspan="2" width="20%">開放性<br>意見表<br>下載(22I餐廳)</th>
                            <th class="text-center" rowspan="2">開放性<br>意見表<br>下載(22J其他)</th>
                        </tr>
                        <tr>
                    ...
                    <?php foreach ($datas as $data): ?>
                        <tr class="text-center">
                            ...
                            <td>
                                <?php if(!empty($data['export_url_1'])){ ?>
                                    <a href="<?=$data['export_url_1']?>"><button type="button" class="btn btn-info btn-sm">開放性<br>意見表</button></a>
                                <?php } ?>
                            </td>
                            <td>
                                <?php if(!empty($data['export_url_2_1'])){ ?>
                                    <a href="<?=$data['export_url_2_1']?>"><button type="button" class="btn btn-info btn-sm">開放性<br>意見表(滿意)</button></a>
                                <?php } ?>
                                <?php if(!empty($data['export_url_2_2'])){ ?>
                                    <a href="<?=$data['export_url_2_2']?>"><button type="button" class="btn btn-info btn-sm">開放性<br>意見表(不滿意)</button></a>
                                <?php } ?>
                            </td>
                            <td>
                                <?php if(!empty($data['export_url_3'])){ ?>
                                    <a href="<?=$data['export_url_3']?>"><button type="button" class="btn btn-info btn-sm">開放性<br>意見表</button></a>
                                <?php } ?>
                            </td>
                        </tr>
                        <?php endforeach?>
...
$(document).ready(function() {
    $("#test1").datepicker({defaultDate: "2001-10-01",});
    ...
    $("#datepicker1").datepicker({defaultDate: "2001-10-01",});
