                ...
                <table  border="1" id="printTable" class="table table-bordered table-condensed table-hover">
                    ...
                    <tbody>
                        ...
                        <tr class="text-center">
                            ...
                            <td><?=htmlspecialchars($data["score"]*20,ENT_HTML5|ENT_QUOTES)?></td>
                            <td><?=htmlspecialchars($data["male"]*20,ENT_HTML5|ENT_QUOTES)?></td>
                            <td><?=htmlspecialchars($data["female"]*20,ENT_HTML5|ENT_QUOTES)?></td>
                            <td>
