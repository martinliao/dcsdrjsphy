        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <table border="1" id="printTable" class="table table-bordered table-condensed table-hover">
                    <thead>
                        <tr>
                            <th class="text-center" colspan="10">臺北市政府公務人員訓練處 講座特殊需求一覽表</th>
                        </tr>
                        <tr>
                            <th class="text-center">姓名</th>
                            <th class="text-center">任職機關</th>
                            <th class="text-center">特殊需求</th>
                            <th class="text-center">特殊需求或異動日期</th>
                        </tr>
                    </thead>
                    <tbody>
                       
                        <?php foreach ($datas['rows'] as $key => $data): ?>
                        
                        <tr class="text-center">
                            <td><?= $data["name"]?></td>
                            <td><?= $data["corp"]?></td>
                            <td><?= $data["special_require"]?></td>
                            <td><?= $data["SPECIAL_DATE"]?></td>
                        </tr>
