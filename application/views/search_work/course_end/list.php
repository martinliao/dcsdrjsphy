        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <table border="1" id="printTable" class="table table-bordered table-condensed table-hover">
                    <thead>
                        <tr>
                            <th class="text-center" colspan="10">臺北市政府公務人員訓練處 結訓班期一覽表</th>
                        </tr>
                        <tr>
                            ...
                            <th class="text-center">應完成日(開課迄日加上七天)</th>
                            <th class="text-center">實際完成日</th>
                        </tr>
                    </thead>
                    <tbody>
...
$(document).ready(function() {
    ...
    $('#Search').click(function(){
        ...
        $('#sact').val('search');
        console.log($('select[name=rows]').val())
