        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <table  border="1" id="printTable" class="table table-bordered table-condensed table-hover">
                    <thead>
                        <tr>
                            <th class="text-center" colspan="9">臺北市政府公務人員訓練處 每日班期實調人數統計表</th>
                        </tr>
                        <tr>
                    ...
                    <tbody>
                        ...
                        <tr class="text-center">
                            <td><?= $data["d"]?></td>
                            <td><?= $data["dayofweek"] ==null?"" :$dayOfWeek[$data["dayofweek"]]?></td>
                            <td><?= $data["series"]?></td>
                            <td><?= $data["description"]?></td>
                            <td><?= $data["class_name"]?></td>
                            <td><?= $data["term"]?></td>
                            <td><?= $data["room_id"]?></td>
                            <td><?= Number_format($data["pcount"])?></td>
                            <td><?= ($data["FIRST_NAME"]."(".$data["tel"].")") =="()" ? "" : ($data["FIRST_NAME"]."(".$data["tel"].")")    ?></td>
                        </tr>
                        <?php $total = $total + $data["pcount"]; ?>
                        <?php endforeach?>
                        <tr class="text-left">
                            <td colspan="7">合計</td>
