<!-- <?= json_encode($datas)?> -->
<!-- <?= json_encode(isset($datas["rows"][-1]))?> -->
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <table  border="1" id="printTable" class="table table-bordered table-condensed table-hover">
                    <thead>
                        <tr>
                            <th class="text-center" colspan="8">臺北市政府公務人員訓練處 各類班期局處未報到人數統計表</th>
                        </tr>
                        <tr>
                            <th class="text-center">類別</th>
                            <th class="text-center">次類別</th>
                            <th class="text-center">班期名稱</th>
                            <th class="text-center">未報到人數</th>
                    ...
                    <tbody>
                            <?php if(sizeof($datas)!=0){?>
                                ...
                                <tr class="text-center">
                                    <?php if(isset($data['type_name'])){?>
                                        <td><?= $data["type_name"]?></td>
                                        <td><?= $data["bname"]?></td>
                                        <td><?= $data["year"]."年". $data["class_name"]."第". $data["term"]."期"?></td>
                                        <td><?= $data["count"]?></td>
                                        <?php if(isset($data['bureausInfo'])){?>
                ...
                <?php
                    if (sizeof($datas)!=0 && count($datas['rows'])==0){
