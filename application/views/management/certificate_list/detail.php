                    ...
                    <div class="row">
                        ...
                        <div class="row">
                            <div class="col-xs-6">
                                ...
                                <div class="col-xs-12">
                                    <label class="control-label"><font color="RED">*</font>書證文號:</label>
                                ...
                                <div class="col-xs-12">
                                    ...
                                    <select class="form-control" id="cer_type" name="cer_type" onchange="get_img_file_id()">
                                        <?php
                                        if(empty($cer_list_data['type_id'])){
                                            //$cer_list_data['type_id'] = 7;  //2021-12-29 設定預設值
                                        }
                            ...
                            <div class="col-xs-6">
                                <div class="col-xs-12">
                                    <table style="border-width:3px; border-style:  ridge; border-color:green; width:80%;" cellpadding="10" border='0'>
                                        ...
                                        <tr><td style="background-color:#FFFFFF;">&nbsp<<姓名>>></td></tr>
                                        <tr><td style="background-color:#FFFFFF;">&nbsp<<服務單位>></td></tr>
                                        <tr><td style="background-color:#FFFFFF;">&nbsp<<職稱>></td></tr>
                                        <tr><td style="background-color:#FFFFFF;">&nbsp<<名次>></td></tr>
                                        <tr><td style="background-color:#FFFFFF;">&nbsp<<班期名稱>></td></tr>
                                        ...
                                        <tr><td style="background-color:#FFFFFF;">&nbsp<<日期迄>></td></tr>
                                        <tr><td style="background-color:#FFFFFF;">&nbsp<<開訓日期>></td></tr>
                                        <tr><td style="background-color:#FFFFFF;">&nbsp<<結訓日期>></td></tr>
                                        <tr><td style="background-color:#FFFFFF;">&nbsp&lt;BR&gt;為換行的html語法</td></tr>
                                    </table>
                                </div>  
                            </div>
                        </div>
                        ...
                        <!-- <div class="col-xs-12">
                            <label class="control-label"><font color="RED">*</font>發證類型:</label>
                            <input type="radio" name="certificate_type" value="1" style="height:auto">府頒證書&nbsp&nbsp
                            <input type="radio" name="certificate_type" value="2" style="height:auto">處頒證書&nbsp&nbsp
                            <input type="radio" name="certificate_type" value="11" style="height:auto">府頒獎狀&nbsp&nbsp
                            <input type="radio" name="certificate_type" value="12" style="height:auto">處頒獎狀&nbsp&nbsp
                        </div> -->
                        <div class="col-xs-12">
                            <div class="col-xs-5">
                                <!--
                                <label class="control-label"><font color="RED">*</font>套印期別:</label>
                                <input type="radio" name="certificate_term" value="1" style="height:auto">是&nbsp&nbsp
                                <input type="radio" name="certificate_term" value="2" style="height:auto">否&nbsp&nbsp
                                -->
                            </div>
                            <div class="col-xs-7">
...
function download_cer(){
    $('#view_one').val('');
    url = '<?=base_url('management/certificate_list/admin_download_cer_pdf')?>';
    var ck_box = [];
    /*
...
function get_img_file_id(){
    ...
    $.ajax({
                ...
                success: function(json) {
                    ...
                    $("input[name='special_type']").val(json.special_type); //更新是否為特殊格式																										 

                    //alert(json.bg_file_name);
                }
            });
    //alert(cer_type);
}
