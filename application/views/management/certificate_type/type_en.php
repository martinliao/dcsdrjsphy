<div class="row">
    <div class="col-lg-12">
        <div class="panel panel-default">
            <div class="panel&#45;heading">30O 書證管理區(新增/修改英文書證版型)
                        ...
                        <div class="col-xs-12">
                            <div class="col-xs-4">
                                ...
                                <div class="row">
                                    ...
                                    <input type="text" name="cer_unit" class="form-control" value="<?=htmlspecialchars($detail_data['cer_unit'],ENT_HTML5|ENT_QUOTES)?>">
                                </div>
                                <BR>                             
                                <div class="row">
                                    <label class="control-label">QRcode上方文字:</label>
                                    <input type="text" name="qr_top_text" class="form-control" value="<?=htmlspecialchars($type_data['qr_top_text'],ENT_HTML5|ENT_QUOTES)?>">
                                </div>
                                <BR>                             
                                <div class="row">
                                    <label class="control-label">QRcode下方文字:</label>
                                    <input type="text" name="qr_bottom_text" class="form-control" value="<?=htmlspecialchars($type_data['qr_bottom_text'],ENT_HTML5|ENT_QUOTES)?>">
                                </div>
                                ...
                                <div class="row" style="margin:20px 0px 0px 0px;display: inline-block;display:none">
                                    <div class="row" style="float:left; margin-right:20px">
                            ...
                            <div class="col-xs-4">
                                ...
                                <div class="row">
                                Having successfully completed the<br> Personnel English Training Course in 
...
function delete_file(file_sl){
        ...
        if (del_txt == '新增'){
            ...
            if (yes) {
                ...
                var link  = '<?=base_url('management/certificate_type/delete_file_by_id_en')?>';
                var data = {
                    '<?=$csrf["name"];?>': '<?=$csrf["hash"];?>',
                    'id': del_id,
                    'file_sl' : file_sl                
...
function view_cer(){
    document.getElementById("action").value = 'view_cer';
        ...
        //var url = '<?=base_url('management/certificate_type/en_type_add');?>';
        var url = '<?=$save_url?>';
        $.ajax({
                    type: "POST",
