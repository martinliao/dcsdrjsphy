    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form class="form-inline" method="POST" action="<?=base_url("management/leave_approval/add")?>">
                    ...
                    <input type="button" class="btn btn-info" value="同意" style="background-color: orange" onclick="confirmFun()">
                </form>
                ...
                <table class="table table-bordered table-condensed table-hover">
                    <thead>
                        <tr style="background: #8CBBFF;">
                            <th width="10%">同意鍵全選<input type="checkbox" id="chkall" onclick="checkAll(this,'chk[]')"></th>
                            <th>學號</th>
                            <th>姓名</th>
                            <th>請假日期</th>
                            <th>時間起迄</th>
                    ...
                    <tbody>
                        <form id="data-form" role="form" class="form-inline" method="POST" action="<?=$link_approval?>">  
                        <input type="hidden" name="<?=$csrf['name'];?>" value="<?=$csrf['hash'];?>" >
                        <input type="hidden" name="year" id="year" value="<?=$class_info['year']?>">
                        <input type="hidden" name="term" id="term" value="<?=$class_info['term']?>">
                        <input type="hidden" name="class_no" id="class_no" value="<?=$class_info['class_no']?>">
                        ...
                        <tr>
                            <td style="text-align: center;"><input type="checkbox" name="chk[]" value="<?=$value['id']?>"></td>
                            <td><?=$value['st_no']?></td>
                            <td><?=$value['name']?></td>
                            ...
                            <td><?=($value['approval']==1)?'<font color="red">同意</font>/'.$value['approver']:''?></td>
                        </tr>
                        <?php endforeach ?>
                        </from>
                    </tbody>
...
function editFun(url){
    ...
    window.open(url, 'edit', config='height=500,width=500');
}
</script>