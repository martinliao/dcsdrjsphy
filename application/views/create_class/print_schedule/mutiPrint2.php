	...
	<div id="require_query_form">
        ...
        <table class="grid2" width="600px" style="font-family:'標楷體';"    >
            <thead>
                <tr>
                    <th class="grid2 th" width="60px" style="background-color:#5D7B9D">日期</th>
                    <th class="grid2 th" width="60px" style="background-color:#5D7B9D">星期</th>
                    <th class="grid2 th" width="110px" style="background-color:#5D7B9D">時間</th>
                    <th class="grid2 th" width="150px" style="background-color:#5D7B9D">課程</th>
                    <th class="grid2 th" width="120px" style="background-color:#5D7B9D">講座</th>
                    <?php if($schedule['muti_room']): ?>
                        <th class="grid2 th" width="100px" style="background-color:#5D7B9D">上課地點</th>
                    <?php endif ?>
                </tr>
            </thead>
            <tbody>
                ...
                <tr><?php  $use_date = new DateTime($phy->use_date); ?>
                    <td class="grid2 td">
