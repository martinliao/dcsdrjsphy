                ...
                <div id="filter-form" role="form" class="form-inline">
                    <div class="row">
                        <div class="col-xs-12">
                           ...
                           <a href="<?=$link_cancel_edit?>"><button type="button" class="btn btn-info btn-sm" style="background-color: #C55A11">取消修改</button></a>
                           <button id="del" class="btn btn-info btn-sm" style="background-color: #548235">刪除</button>
                        </div>
                    </div>
                </div>
                <!-- /.table head -->
                        ...
                        <?php
                            for($i=0;$i<$days;$i++){
                                ...
                                if(isset($data_list[$key])){
                                    echo '<td style="background-color:#FFF2CC">';
                                    echo $data_list[$key]['description1'];
                                    echo '<input type="checkbox" name="lounge[]" value="'.$data_list[$key]['id'].'" '.$disabled.'>';
                                    echo $data_list[$key]['description2'];
                                    echo $data_list[$key]['description3'];
                                    echo '</td>';
                                } else {
                                    echo '<td><input type="checkbox" name="lounge[]" value="'.$data_list[$key]['id'].'" disabled>空休息室</td>';
                                }
                                ...
                                $key = 'A_C305_'.$thisday;
                                if(isset($data_list[$key])){
                                    echo '<td style="background-color:#FFF2CC;border-bottom:3px solid #000000">';
                                    echo $data_list[$key]['description1'];
                                    echo '<input type="checkbox" name="lounge[]" value="'.$data_list[$key]['id'].'" '.$disabled.'>';
                                    echo $data_list[$key]['description2'];
                                    echo $data_list[$key]['description3'];
                                    ...
                                    echo '<td style="border-bottom:3px solid #000000"><input type="checkbox" name="lounge[]" value="'.$data_list[$key]['id'].'" disabled>空休息室</td>';
                                }
