                    ...
                    <table class="table table-bordered table-condensed table-hover">
                        <thead>
                            <tr>
                                ...
                                <th class="sorting<?=($filter['sort']=='machine_code asc')?'_asc':'';?><?=($filter['sort']=='machine_code desc')?'_desc':'';?>" data-field="machine_code" >機器內碼</th>
                                <th class="sorting<?=($filter['sort']=='room_id asc')?'_asc':'';?><?=($filter['sort']=='room_id desc')?'_desc':'';?>" data-field="room_id" >教室代碼</th>
                                <th>功能</th>
                            </tr>
                        </thead>
                        <tbody>
