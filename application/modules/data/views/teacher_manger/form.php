...
<form id="data-form" role="form" method="post" action="<?=$link_save2;?>" enctype="multipart/form-data">
    ...
    <div class="form-group <?=form_error('image')?'has-error':'';?>">
        ...
        <div class="image-block">
            ...
            <input type="file" name="upload" style="display: none;" onchange="changeImage(this);" accept=".png,.jpg">
        </div>
    ...
    <div class="form-group required col-xs-6 <?=form_error('idno')?'has-error':'';?>">
        ...
        <?php } else { ?>
        <input class="form-control" name="idno" placeholder="" value="<?=$form['idno'];?>" readonly>
        <?php }?>
        <?=form_error('idno'); ?>
    </div>
    ...
    <div class="form-group col-xs-6 <?=form_error('rpno')?'has-error':'';?>">
        ...
        <?php } else { ?>
        <input class="form-control" name="rpno" placeholder="" value="<?=$form['rpno'];?>" readonly>
        <?php }?>
        <?=form_error('rpno'); ?>
    </div>
    ...
    <div class="form-group required col-xs-6 <?=form_error('birthday')?'has-error':'';?>">
        ...
        <div class="input-daterange input-group" id="datepicker">
            <input type="text" class="form-control datepicker" name="birthday" id="test1"  value="<?=set_value('birthday', substr($form['birthday'], 0, -8));?>"/>
    ...
    <div class="form-group col-xs-6 <?=form_error('another_name')?'has-error':'';?>">
        ...
        <input class="form-control" name="another_name" placeholder="" value="<?=set_value('another_name', $form['another_name']); ?>">
    ...
    <div class="form-group required col-xs-6 <?=form_error('institution')?'has-error':'';?>">
        ...
        <input class="form-control" name="institution" placeholder="" value="<?=set_value('institution', $form['institution']); ?>">
    ...
    <div class="form-group required col-xs-6 <?=form_error('job_title')?'has-error':'';?>">
        ...
        <input class="form-control" name="job_title" placeholder="" value="<?=set_value('job_title', $form['job_title']); ?>">
    ...
    <div class="form-group col-xs-6 <?=form_error('major')?'has-error':'';?>">
        ...
        <input class="form-control" name="major" placeholder="" value="<?=set_value('major', $form['major']); ?>">
        <?=form_error('major'); ?>
    </div>
    ...
    <div class="form-group col-xs-6 required <?=form_error('zipcode') || form_error('route')?'has-error':'';?>">
        ...
        <input class="form-control" name="route"  value="<?=set_value('route', $form['route']); ?>">
        <?=form_error('zipcode'); ?>
        <?=form_error('route'); ?>
    </div>
    ...
    <div class="form-group col-xs-6 <?=form_error('c_tel')?'has-error':'';?>">
        ...
        <input class="form-control" name="c_tel" placeholder="" value="<?=set_value('c_tel', $form['c_tel']); ?>">
        <?=form_error('c_tel'); ?>
    </div>

    <div class="form-group col-xs-6 <?=form_error('c_tel2')?'has-error':'';?>">
        <label class="control-label">公司電話2</label>
        <input class="form-control" name="c_tel2" placeholder="" value="<?=set_value('c_tel2', $form['c_tel2']); ?>">
        <?=form_error('c_tel2'); ?>
    </div>

    <div class="form-group col-xs-6 <?=form_error('h_tel')?'has-error':'';?>">
        <label class="control-label">家用電話1</label>
        <input class="form-control" name="h_tel" placeholder="" value="<?=set_value('h_tel', $form['h_tel']); ?>">
        <?=form_error('h_tel'); ?>
    </div>

    <div class="form-group col-xs-6 <?=form_error('h_tel2')?'has-error':'';?>">
        <label class="control-label">家用電話2</label>
        <input class="form-control" name="h_tel2" placeholder="" value="<?=set_value('h_tel2', $form['h_tel2']); ?>">
        <?=form_error('h_tel2'); ?>
    </div>
    ...
    <div class="form-group col-xs-6 <?=form_error('mobile')?'has-error':'';?>">
        ...
        <input class="form-control" name="mobile" placeholder="" value="<?=set_value('mobile', $form['mobile']); ?>">
        <?=form_error('mobile'); ?>
    </div>
    ...
    <div class="form-group col-xs-6 <?=form_error('email2')?'has-error':'';?>">
        ...
        <input class="form-control" name="email2" placeholder="email@example.com" value="<?=set_value('email2', $form['email2']); ?>">
        <?=form_error('email2'); ?>
    </div>

    <div class="form-group col-xs-6 required <?=form_error('bank_code')?'has-error':'';?>">
        <label class="control-label">【銀行(郵局)分行】</label>
        <input type="button" class="btn btn-xs btn-primary" onclick="show_bank()" value="查詢">
        <input type="hidden" class="form-control" name="bank_code" id="aBank" placeholder="" value="<?=set_value('bank_code', $form['bank_code']); ?>">
        <input class="form-control" name="bank_code_name" id="aBankName" disabled value="<?=set_value('bank_code_name', $form['bank_code_name']); ?>">
    ...
    <div class="form-group required col-xs-6  <?=form_error('bank_account')?'has-error':'';?>">
        ...
        <input class="form-control" name="bank_account" id="aAccount" placeholder="" value="<?=set_value('bank_account', $form['bank_account']); ?>">
    ...
    <div class="form-group required col-xs-6 <?=form_error('account_name')?'has-error':'';?>">
        ...
        <input class="form-control" name="account_name" placeholder="" value="<?=set_value('account_name', $form['account_name']); ?>">
    ...
    <div class="form-group col-xs-6 <?=form_error('contact_person')?'has-error':'';?>">
        ...
        <input class="form-control" name="contact_person" placeholder="" value="<?=set_value('contact_person', $form['contact_person']); ?>">
    ...
    <div class="form-group col-xs-6 <?=form_error('contact_tel')?'has-error':'';?>">
        ...
        <input class="form-control" name="contact_tel" placeholder="" value="<?=set_value('contact_tel', $form['contact_tel']); ?>">
    ...
    <div class="form-group col-xs-6 <?=form_error('experience')?'has-error':'';?>">
        ...
        <textarea class="form-control" name="experience" style="height: 110px;"><?=set_value('experience', $form['experience']); ?></textarea>
    ...
    <div class="form-group col-xs-6 <?=form_error('demand')?'has-error':'';?>">
        ...
        <textarea class="form-control" name="demand" style="height: 110px;"><?=set_value('demand', $form['demand']); ?></textarea>
        <?=form_error('demand'); ?>
    </div>

    <div class="form-group col-xs-6 <?=form_error('introduction')?'has-error':'';?>">
        <label class="control-label">講座介紹</label>
        <textarea class="form-control" name="introduction" style="height: 110px;"><?=set_value('introduction', $form['introduction']); ?></textarea>
    ...
    <div class="form-group col-xs-6">
        ...
        <input type="button" class="btn btn-xs btn-primary" onclick="show_course('<?=$page_name?>', '<?=$u_id?>')" value="新增">
        <input type="button" class="btn btn-xs btn-danger" onclick="delCS()" value="刪除">
...
$(function() {
    if (<?=$form["zipcode"]=='６００'? 'true' : 'false'?>){
        $('#twzipcode').twzipcode({
            countySel: '嘉義市',
            districtSel: '西區',
            detect: false,
        ...
        $('#twzipcode').twzipcode({
            detect: false,
            zipcodeSel: '<?=set_value("zipcode", mb_substr($form["zipcode"], 0, 3));?>',
            css: ['county', 'district', 'zipcode'],
            readonly: false,
        });
    }
