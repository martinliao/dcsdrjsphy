                    ...
                    <table class="table table-bordered table-condensed table-hover">
                        <thead>
                            <tr>
                                ...
                                <th class="sorting<?=($filter['sort']=='name asc')?'_asc':'';?><?=($filter['sort']=='name desc')?'_desc':'';?>" data-field="name" >縣市</th>
                                <th class="sorting<?=($filter['sort']=='add_val1 asc')?'_asc':'';?><?=($filter['sort']=='add_val1 desc')?'_desc':'';?>" data-field="add_val1" >單程票價</th>
                                <th class="sorting<?=($filter['sort']=='add_val2 asc')?'_asc':'';?><?=($filter['sort']=='add_val2 desc')?'_desc':'';?>" data-field="add_val2" >交通費</th>
                                <th>功能</th>
                            </tr>
                        </thead>
                        <tbody>
