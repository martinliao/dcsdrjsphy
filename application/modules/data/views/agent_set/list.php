                    ...
                    <table class="table table-bordered table-condensed table-hover">
                        <thead>
                            <tr>
                                ...
                                <th class="sorting<?=($filter['sort']=='item_id asc')?'_asc':'';?><?=($filter['sort']=='item_id desc')?'_desc':'';?>" data-field="item_id" >承辦人</th>
                                <th class="sorting<?=($filter['sort']=='ext1 asc')?'_asc':'';?><?=($filter['sort']=='ext1 desc')?'_desc':'';?>" data-field="ext1" >承辦人分機</th>
                                <th class="sorting<?=($filter['sort']=='name asc')?'_asc':'';?><?=($filter['sort']=='name desc')?'_desc':'';?>" data-field="name" >代理人</th>
                                <th class="sorting<?=($filter['sort']=='ext2 asc')?'_asc':'';?><?=($filter['sort']=='ext2 desc')?'_desc':'';?>" data-field="ext2" >代理人分機</th>
