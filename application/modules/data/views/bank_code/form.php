...
<form id="data-form" role="form" method="post" action="<?=$link_save;?>">
    ...
    <div class="form-group col-xs-6 <?=form_error('cancel_flag')?'has-error':'';?>">
        <label class="control-label">取消註記</label>
        <input class="form-control" name="cancel_flag" placeholder="" value="<?=set_value('cancel_flag', $form['cancel_flag']); ?>">
        <?=form_error('cancel_flag'); ?>
    </div>
