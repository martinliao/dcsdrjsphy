		...
		switch($dest) {
			case 'I': {
				...
				if (php_sapi_name() != 'cli') {
					...
					header('Content-Disposition: inline; filename="'.$downloadName.'"'); // 為了支援中文
			...
			case 'D': {				
				...
				header('Content-Disposition: attachment; filename="'.$downloadName.'"'); // 為了支援中文
